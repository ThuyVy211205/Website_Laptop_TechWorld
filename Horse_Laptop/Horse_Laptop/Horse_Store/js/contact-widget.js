    ...
    const addEventListeners = () => {
        ...
        zaloButtons.forEach(btn => {
            btn.addEventListener('click', (e) => {
                e.preventDefault();
                showQRModal('Zalo', 'images/anhzalo.jpg', 'Quét mã QR hoặc tìm kiếm Horse Store trên Zalo');
            });
        });
        ...
        messengerButtons.forEach(btn => {
            btn.addEventListener('click', (e) => {
                e.preventDefault();
                showQRModal('Messenger', 'images/anhmess.jpg', 'Quét mã QR để kết nối với Horse Store trên Messenger');
            });
        });
